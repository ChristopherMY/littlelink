        ...
        <div class="column">
            ...
            @if (file_exists(base_path('littlelink/images/avatar.png')))
                <img alt="avatar" src="{{ asset('littlelink/images/avatar.png') }}"
                    srcset="{{ asset('littlelink/images/avatar@2x.png 2x') }}" width="200px" height="200px">
            @else
                <div class="logo-container">
                    <img src="{{ asset('littlelink/images/logo.svg') }}" alt="Logo"
                        style="width:200px; height:200px;">
                </div>
            @endif

            <div style="padding-bottom:5%;">
                <h1 style="font-size: 300%;"><i class="fa-solid fa-screwdriver-wrench"></i> Nos encontramos en
                    mantenimiento <i class="fa-solid fa-screwdriver-wrench"></i></h1>
                <h2>Estamos realizando mantenimiento programado del sitio en este momento.</h2>
                <h3>Vuelva a consultarnos más tarde.</h3>
            </div>
