...
<details>
    ...
    <a href="{{ url('update/theme') }}" onclick="updateicon()" class="mt-3 ml-3 btn btn-info row"><span id="updateicon" class=""><i class="bi bi-arrow-repeat"></i></span> Actualizar todos los
        themes</a><br><br>
    <script>
        function updateicon() {
