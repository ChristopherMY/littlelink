@if (env('ENABLE_BUTTON_EDITOR') === true)
    ...
    @section('content')
        @push('sidebar-scripts')
            ...
            {
                return str_replace(['http://', 'https://'], '', $urlStrp);
            } ?>
            <!-- start button editor -->
            <script>
        ...
        <div>
            <h2 class="mb-4"><i class="bi bi-pen"> Button Editor</i>
                ...
                <br><br><a class="btn btn-primary" href="{{ url('/studio/links') }}">⬅ Regresar</a>
                ...
                <div style="left: 10px;">
                    <div class="modal-profile">
                        <h2>CSS</h2>
                        <a class="modal-close-profile" title="Close profile window" href="#"><img
                                src="./images/close.png" alt="Close profile window" /></a>
                        <div id="output">
                        </div>
                    </div>
                    ...
                    <aside id="panel-right">
                        ...
                        <div class="tool">
                            <heading>Color &nbsp;<span>Texto</span></heading>
                            </br>
                            <input type="button" id="color"
                                style="background-color:#FFFFFF; border:thin solid white;height:50px;width:50px;margin-left:5px;">
                        </div>

                        </br>

                        <div class="tool">
                            <heading>background &nbsp;<span>gradiente</span></heading>
                            </br>
                    ...
                    <section id="preview">
                        @if ($buttonId == 1)
                            <center>
                                <div id="sample"
                                    style="--delay: 1s; border-radius:8px !important; max-width: 400px; width: 80%; class="button-entrance">
                                    <div class="button-demo button hvr-grow hvr-icon-wobble-vertical"><img
                                            class="icon hvr-icon"
                                            src="{{ asset('\/littlelink/icons\/') . 'custom' }}.svg">{{ $title }}
                                    </div>
                                </div>
                            </center>
                        @else
                            <center>
                                <div id="sample"
                                    style="--delay: 1s; border-radius:8px !important; max-width: 400px; width: 80%; class="button-entrance">
                                    <div class="button-demo button hvr-grow hvr-icon-wobble-vertical"><img
                                            class="wicon hvr-icon"
                                            src="https://icons.duckduckgo.com/ip3/{{ strp($link) }}.ico">{{ $title }}
                                    </div>
                                </div>
                            </center>
                        @endif
                    ...
                    <div style="padding-left: 15px;">
                        <form action="{{ route('editCSS', $id) }}" method="post">
                            ...
                            <div class="form-group col-lg-8"><br>
                                ...
                                <textarea name="custom_css" rows="9" id="sCode" type="text" value="{{ $custom_css }}"
                                    class="form-control" required>{{ $custom_css }}</textarea>
                            </div>
                    </div>
                </details>
...
NULL
                    ...
                    <button type="submit" class="mt-3 ml-3 btn btn-info">Restablecen a los predeterminados</button>
                </form>

                <br><br>
                <div id="result"
                    style="left: 1%; position: relative; background-color:#2c2d3a; border-radius: 25px; min-width:300px; max-width:950px; height:300px; box-shadow: 0 10px 20px -10px rgba(0,0,0, 0.6);">
                    <div style="position: relative; top: 50%; transform: translateY(-50%);">
                        <h2 align="center" style="color:white">Result:</h2>
                        @if ($custom_css === '' or $custom_css === 'NULL' and $buttonId == 1)
                            <center>
                                <div style="--delay: 1s" class="button-entrance">
                                    <div class="button-demo button-custom button hvr-grow hvr-icon-wobble-vertical"><img
                                            class="icon hvr-icon fa {{ $custom_icon }}">{{ $title }}</div>
                                </div>
                            </center>
                        @elseif($custom_css === '' or $custom_css === 'NULL' and $buttonId == 2)
                            <center>
                                <div style="--delay: 1s" class="button-entrance">
                                    <div class="button-custom_website button hvr-grow hvr-icon-wobble-vertical"><img
                                            class="wicon hvr-icon"
                                            src="https://icons.duckduckgo.com/ip3/{{ strp($link) }}.ico">{{ $title }}
                                    </div>
                                </div>
                        ...
                        @elseif($custom_css != '' and $buttonId == 2)
                            <center>
                                <div style="--delay: 1s" class="button-entrance">
                                    <div style="{{ $custom_css }}"
                                        class="button-custom_website button hvr-grow hvr-icon-wobble-vertical"><img
                                            class="wicon hvr-icon"
                                            src="https://icons.duckduckgo.com/ip3/{{ strp($link) }}.ico">{{ $title }}
                                    </div>
                                </div>
                        ...
                        @else
                            <center>
                                <div style="--delay: 1s" class="button-entrance">
                                    <div style="{{ $custom_css }}" class="button-demo hvr-grow hvr-icon-wobble-vertical">
                                        <i style="color: {{ $custom_icon }}"
                                            class="icon hvr-icon fa {{ $custom_icon }}"></i>{{ $title }}
                                    </div>
                                </div>
                            </center>
                        @endif
                ...
                @if ($buttonId == 1)
                    <form action="{{ route('editCSS', $id) }}" method="post">
                        ...
                        <div class="form-group col-lg-8">
                            <h2>Custom Icon</h2>
                            <textarea id="textareabox" type="text" name="custom_icon" value="{{ $custom_icon }}" class="form-control"
                                required>{{ $custom_icon }}</textarea>
                        </div>
                        <script type="text/javascript">
                            ...
                            if (textValue.indexOf(word) == -1) {
                                alert(
                                    'Your custom icon\'s short code does not contain the string "fa-" always use icons in the format: fa-ghost, for example.'
                                )
                            }
                        </script>

                        <details>
                            <p>Se pueden agregar iconos personalizados a los botones a través de Font Awesome. Puede
                                utilizar cualquier icono de la lista
                                a continuación, puede acceder a esta lista haciendo clic en el botón 'Ver todos los iconos'.
                                Cada ícono en eso
                                list tiene un código corto, que puede copiar e ingresar en el campo de icono personalizado.
                            </p>
                            <p>Cada código corto de icono consta de un prefijo y una parte principal. Si el código corto no
                                es una marca
                                icon, simplemente puede ingresar el código en el formato: fa-icon-name. El formato 'fa-...'
                                es
                                importante aquí. Por ejemplo, 'código fa'.</p>
                            <p>Si el código corto es un icono de marca, es importante incluir un "fab" antes del código
                                corto.
                                parte. Nuevamente, el formato 'fa-...' todavía se aplica aquí. Por ejemplo, 'fabuloso
                                fa-github'</p>
                            <p>Para aplicar color a sus íconos, simplemente puede escribir el nombre del color o simplemente
                                escribir el HEX
                                valor antes del icono, seguido de un ';'. Aquí es importante anteponer el color al
                                El código abreviado del icono y el código de color deben terminar con un punto y coma.<br>
                                Puede encontrar una lista de colores disponibles<a
                                    href="https://www.w3schools.com/cssref/css_colors.asp" target="_blank">Aqui</a>.</p>
                            <br>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="max-width: 1%">Icono</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p style="color: red;">red; fa-ghost</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Color HEX</td>
                                        ...
                                        <td>
                                            <p style="color: #1DA1F2;">#1DA1F2; fab fa-twitter</p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="row">
                            <button type="submit" class="mt-3 ml-3 btn btn-info">Actualizar icono</button>
                            <button class="mt-3 ml-3 btn btn-info"><a href="https://fontawesome.com/search?m=free"
                                    target="_blank">Ver todos los iconos</a></button>
                        </div>
                    </form><br><br><br><br>
                @endif
        ...
        <a class="btn btn-primary" href="{{ url('/studio/links') }}">⬅ Regresar</a>
    @endsection
@endif
